...
local response = HttpService:GetAsync("https://raw.githubusercontent.com/XAtomMaster339871/imendingitall/main/CameraShakeInstance.lua")

local CameraShakeInstance = loadstring(response)()
...
function CameraShaker.new(callback)
